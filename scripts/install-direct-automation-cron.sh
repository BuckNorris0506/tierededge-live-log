...
SHELL=/bin/sh
0 6 * * * export PATH=/usr/local/bin:/usr/bin:/bin; export LIVE_LOG_DEPLOY_REPO="/Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log"; cd /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log && /usr/bin/env node /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log/scripts/run-scheduled-canonical-hunt-launcher.mjs --job-name morning-edge-hunt >> /tmp/tierededge-morning-edge-hunt.log 2>&1
0 9 * * * export PATH=/usr/local/bin:/usr/bin:/bin; export LIVE_LOG_DEPLOY_REPO="/Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log"; cd /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log && /usr/bin/env node /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log/scripts/run-scheduled-canonical-hunt-launcher.mjs --job-name midmorning-edge-hunt >> /tmp/tierededge-midmorning-edge-hunt.log 2>&1
0 12 * * * export PATH=/usr/local/bin:/usr/bin:/bin; export LIVE_LOG_DEPLOY_REPO="/Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log"; cd /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log && /usr/bin/env node /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log/scripts/run-scheduled-canonical-hunt-launcher.mjs --job-name midday-edge-hunt >> /tmp/tierededge-midday-edge-hunt.log 2>&1
0 15 * * * export PATH=/usr/local/bin:/usr/bin:/bin; export LIVE_LOG_DEPLOY_REPO="/Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log"; cd /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log && /usr/bin/env node /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log/scripts/run-scheduled-canonical-hunt-launcher.mjs --job-name afternoon-edge-hunt >> /tmp/tierededge-afternoon-edge-hunt.log 2>&1
0 18 * * * export PATH=/usr/local/bin:/usr/bin:/bin; export LIVE_LOG_DEPLOY_REPO="/Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log"; cd /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log && /usr/bin/env node /Users/jaredbuckman/Documents/Playground/TieredEdge-Live-Bet-Log/scripts/run-scheduled-canonical-hunt-launcher.mjs --job-name evening-edge-hunt >> /tmp/tierededge-evening-edge-hunt.log 2>&1
