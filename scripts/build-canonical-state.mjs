...
function main() {
  ...
  const payload = {
    ...
    live_execution: {
      ...
      hedge_summary: executionBoard.hedge_summary || {
        total_positions: 0,
        let_ride_count: 0,
        consider_hedge_count: 0,
        strong_hedge_count: 0,
      },
      hedge_decisions: executionBoard.hedge_decisions || [],
      hedge_operator_output: executionBoard.hedge_operator_output || [],
      hedge_scan_frequency_mode: executionBoard.hedge_scan_frequency_mode || 3,
      hedge_thresholds_active: executionBoard.hedge_thresholds_active || null,
      meaningful_stake_rule: executionBoard.meaningful_stake_rule || null,
